...
ui <- navbarPage("BikeAnalyzer",
    ...
    tabPanel("When are most people riding bikes",
             sidebarLayout(
                 sidebarPanel(
                     p("This plot shows at what time of the day people are ridding bikes"),
                     selectInput("weekday",
                                 "Day of the week",
                                 list('Monday' = 1, 'Thousday' = 2,'Wednesday' = 3,'Thursday' = 4,'Friday' = 5,'Saturday' = 6,'Sunday' = 7))
                 ),
                 mainPanel(
